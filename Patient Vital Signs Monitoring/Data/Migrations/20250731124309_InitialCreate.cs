        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientModelPatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patients", x => x.PatientId);
                    table.ForeignKey(
                        name: "FK_Patients_Patients_PatientModelPatientId",
            ...
            migrationBuilder.InsertData(
                table: "VitalSigns",
                columns: new[] { "VitalSignsId", "BloodPressure", "HeartRate", "OxygenSaturation", "PatientId" },
                values: new object[,]
                {
                    { new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa1"), "120/80", 72, 98, new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa1") },
                    { new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa2"), "130/85", 80, 97, new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa2") },
                    { new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa3"), "110/75", 65, 100, new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa3") }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_PatientModelPatientId",
                table: "Patients",
